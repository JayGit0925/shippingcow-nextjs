---
draft: true
# UNPUBLISHED 2026-07-22 by Jay's ruling. The entire thesis of this article is a
# ShippingCow DIM divisor claim plus a 38–39% savings figure — both banned from
# public surfaces. Not salvageable by editing; do not republish without a logged
# decision in context/decisions/. The slug 301s to /blog/dim-weight-calculator-guide
# (see next.config.js redirects). File kept on disk deliberately.
