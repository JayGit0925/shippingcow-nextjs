...
It's a fair question. The box weighs 65 lbs. The rate sheet says $22. But the actual charge line reads $48. Meanwhile, the same carrier ships your competitor's 5-lb widget for $9, fast and free. What gives?
...
The fix? **A higher DIM divisor.** Raise the divisor far enough and that same box's DIM weight falls below its actual weight — at which point you pay by actual, and the air rides free. That is the single line worth negotiating hardest if you ship dense, heavy goods.
...
| Cost Component | What it does to your bill |
|---|---|
| Base rate (actual weight) | The only part most sellers budget for |
| DIM weight upcharge (139 → 99.7 lbs) | You are billed for ~30 lbs you never shipped |
| Zone amplification | Zone 6 instead of Zone 3 on the same box |
| Accessorials | Residential, oversize, fuel — applied after your discount |

Four lines. Only the first one is about your product. The other three are about how you route and how you pack.

Add them up on a year of your own shipments and it usually is not a shipping cost. It is a second location.
